...
class SIFT(object):
    def __init__(self, im=None, s=3, num_octave=4, s0=1.3, sigma=1.6, r_th=10, t_c=0.03, w=16):
        self.im = convolve(rgb2gray(im), gaussian_filter(s0)) if im is not None else None
        self.s = s
        self.sigma = sigma
    ...
    def set_image(self, im):
        self.im = convolve(rgb2gray(im), gaussian_filter(1.3))
